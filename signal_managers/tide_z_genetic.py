...
def initialise_parent(df=None,
                      ...
                      timeframes = ["1h"],
                      timeframes_to_resample_to = ["2h","3h","4h","6h","8h","12h","24"],
        ...
        if df is None:
            sig_params = {"cols":['open','high','low'],
                          "lookback_bars":[], # 24hours for 5min timeframe (should this lookback be reduced for downsampled timeframes)
                          "timeit":False,
                          "reciprocal":False,
                          "sig_name_1": "z",
                          "sig_name_2":"sig"}
