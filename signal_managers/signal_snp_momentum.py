...
class Signal_Mean_Reversion:
    ...
    def update_model_config(self, model_config):
        ...
        self.timeframe_to_trade = model_config["model_instruments"]["timeframe_to_trade"]
    ...
    def calc_signals(self, instruments_dict: dict, verbose=False):
        ...
        sig_dict_prelim = signals.merge_instruments_dict(instruments_dict = instruments_dict,
                                                         ...
                                                         futures_instruments = self.instruments[1],
        ...
        #  Merge final signals 
        # =================================
        df_sig = composite_signals.merge_signals(sig_dict, smallest_timeframe = self.timeframe_to_trade, target_signal = self.target_signal)
        # self.df_sig = df_sig
        ...
        size_timeframe = self.timeframe_to_trade
    ...
    def rename_signals(self, df_sig):
        ...
        df_trade = df_sig
        target_signal = self.target_signal
        sig_timeframe = self.timeframe_to_trade + "_"
    ...
    def preprocess(self, instruments_dict: dict, verbose=False, timeit=False):
        ...
        resample_to_list = [self.timeframe_to_trade]
        for instrument,instrument_dict in instruments_dict.items():
            ...
            for resample_to in resample_to_list:
                ...
                temp[resample_to] = df_resampled
            instruments_dict2[instrument] = temp
                    
        df_sig = self.calc_signals(instruments_dict2, verbose=verbose)
